...
export class ToolsManager {
            ...
            if (this.state.isMarquee) {
                ...
                if (handleHit) {
                    if (
                        ...
                        this.engine.canvas.style.cursor = 'move';
                    } else if (handleHit.item.type === 'room' || handleHit.item.type === 'boundary' || handleHit.item.type === 'object') {
    ...
    drawOverlay(ctx) {
        ...
        if (
            ...
            if (isBoundary || isStaircaseDraw || isFrameDraw) {
                const threshold = 15 / this.engine.scale;
                const edgeLabelFill = isBoundary ? '#92400e' : isFrameDraw ? '#6b21a8' : '#9f1239';
